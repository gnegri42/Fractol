...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/26 15:11:50 by gnegri            #+#    #+#             */
/*   Updated: 2017/12/26 15:11:53 by gnegri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_draw_calc2(t_mlx *mlx, t_fract *fract, int x, int y)
{
	int		i;
	double	tmp;
